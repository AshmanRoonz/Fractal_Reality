...
**The open connection** (v1.4, Ashman: "truth is an open connection between God and Soul"; developed in the forwarded review; placed here as the definition's missing middle term rather than as a replacement). The v1.2 structure defined Truth (Reality, open as the future) and truths (the settled past) and named the present as the conversion. This sentence supplies what the conversion requires: **the present is where Truth becomes truths through an open connection.** God, Truth open; the connection, kept clear at the soul; the soul, actualizing; truths, settling into the past. One machine.
