...
**K structure:** 59/3 = ladder minus pump/triad. 27 = 3³ (generation 2). 81 = 3⁴ (generation 3). 91 = 7 × 13 (rungs × skeleton key). Mass corrections: K = 3^(n+1) where n is lepton generation. 13 is the skeleton key: generators + compositional whole (A4).
