...
- **The accumulated traversal function**: A(d) = d(2d+1) gives the triangular numbers 0, 1, 3, 6, 10, 15, 21 at each rung. A'(d) = 4d + 1 produces the odd numbers 1, 3, 5, 7, 9, 11, 13 (all framework-meaningful: aperture, triad, ..., rungs, ..., generators+whole). A''(d) = 4 = P (pump phases). At 3D, TYPE A (accumulated) and TYPE B (local splitting) converge: A(3) = E(3) = 21 (closure unifies global and local).
