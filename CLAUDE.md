...
- **Clay Millennium mapping**: The seven Clay problems map one-to-one onto the seven rungs: 0D = Riemann, 0.5D = P vs NP, 1D = Yang-Mills, 1.5D = BSD, 2D = Navier-Stokes, 2.5D = Hodge, 3D = Poincare (solved). The only solved problem is the boundary (3D), the outermost rung.
