...
8.5. [Independent Aperture Flow Control](#85-independent-aperture-flow-control)
...
30.5. [Advanced Technical Supplement: SU(3), Mass Scale, and Quantum Gravity](#305-advanced-technical-supplement-su3-mass-scale-and-quantum-gravity)
...
## 8.5. Independent Aperture Flow Control
...
### 8.5.2 Topological Derivation of λ_ij
...
### 8.5.4 Coupling Constants from β Ratios
...
### 8.5.9 Integration with Main Framework
...
### 9.6 Mapping to Observed Particles
...
### 9.7 Charge Quantization from Field Topology
...
## 30.5 Advanced Technical Supplement: SU(3), Mass Scale, and Quantum Gravity

### 30.5.1 Complete SU(3) Color Formalism

#### 30.5.1.1 Gauge Structure
```
...
#### 30.5.1.2 QCD Lagrangian at D=1.5
```
...
#### 30.5.1.3 Beta Function and Running
```
...
#### 30.5.1.4 Confinement Mechanism
```
...
### 30.5.2 Absolute Mass Scale Derivation

#### 30.5.2.1 Master Formula
```
...
### 30.5.3 Quantum Gravity Formalism

#### 30.5.3.1 Hexa-Metric Structure
```
...
#### 30.5.3.2 Coupled Einstein Equations
```
...
#### 30.5.3.3 Cosmological Constant Solution
```
Effective constants:
Λ^{(-)}_M = -Λ₀ (convergent)
Λ^{(+)}_Φ = +Λ₀ (emergent)
...
#### 30.5.3.4 Aperture Boundary Conditions
```
At Σ_Å (r = r_Å):
...
#### 30.5.3.5 Bimetric Teleparallel Equivalence
```
...
#### 30.5.3.6 Torsion and 3.5D Spacetime
```
...
#### 30.5.3.8 Black Hole Thermodynamics
```
...
- **[Critical_Supplements.md](Critical_Supplements.md)** - Failures, limitations, and experimental protocols
