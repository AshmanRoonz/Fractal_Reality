...
- **[papers/yang_mills_3.5D_dual_interface.md](papers/yang_mills_3.5D_dual_interface.md)** - **Yang-Mills Equations in 3.5D with Dual-Interface Gauge Structure** — Complete formulation of the 8-gauge theory on 3.5D spacetime. Shows how dual interfaces (input/output) create 64-state particle spectrum, explains D ≈ 1.5 worldlines, derives mass gap (1.65 GeV), and provides geometric origin for confinement with zero free parameters. Extends Partanen & Tulkki's interface momentum to gauge fields on flat Minkowski.
