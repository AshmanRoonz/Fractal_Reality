...
Add this section after §4.4 (Scale-Dependent i):
...
This completes the aperture chapter with the fractal unity insight.

---

## Updated Symbol Glossary Entry

Replace the current glossary entry for `i` with:
...
1. **The "why complex numbers?" question**
...
4. **The implementation question**
   → Two layers (numeric + semantic) of same i

The user's insight "same origin, same braid" ties it all together.
```
