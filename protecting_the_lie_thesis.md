...
- **Self-affirmation theory (Steele, 1988):** affirmation of self-integrity in an unrelated domain reduces defensiveness in ordinary populations. This supplies one of the PLM's sharpest discriminating tests (Section 4.3, Prediction 5): if narcissistic defense protects a specific proposition rather than global self-integrity, domain-irrelevant affirmation should fail to reduce it.
...
- Domain-irrelevant affirmation reducing narcissistic defense as effectively as in controls (Steele effect intact in the pathological range).
...
- [ ] Verify every reference against the primary source (all citations in this document are from-memory reconstructions).
- [ ] Run a systematic literature search for prior confirmation-based accounts of supply (the History chapter must establish novelty honestly; if a predecessor exists, cite and build).
- [ ] Trace "narcissistic supplies" in Fenichel to the exact text and year.
...
- Back, M. D., Küfner, A. C. P., Dufner, M., Gerlach, T. M., Rauthmann, J. F., & Denissen, J. J. A. (2013). Narcissistic admiration and rivalry: Disentangling the bright and dark sides of narcissism. Journal of Personality and Social Psychology, 105(6), 1013 to 1037. [verify]
- Baumeister, R. F., & Vohs, K. D. (2001). Narcissism as addiction to esteem. Psychological Inquiry, 12(4), 206 to 210. [verify]
...
- Bushman, B. J., & Baumeister, R. F. (1998). Threatened egotism, narcissism, self-esteem, and direct and displaced aggression: Does self-love or self-hate lead to violence? Journal of Personality and Social Psychology, 75(1), 219 to 229. [verify]
- Fenichel, O. (1945). The psychoanalytic theory of neurosis. Norton. [verify: locate the "narcissistic supplies" passages; also the 1938 paper]
- Festinger, L. (1957). A theory of cognitive dissonance. Stanford University Press.
- Freud, S. (1914). On narcissism: An introduction. [standard edition; verify volume]
- Freyd, J. J. (1997). Violations of power, adaptive blindness and betrayal trauma theory. Feminism & Psychology, 7(1), 22 to 32. [verify: first DARVO statement]
...
- Grapsas, S., Brummelman, E., Back, M. D., & Denissen, J. J. A. (2020). The "why" and "how" of narcissism: A process model of narcissistic status pursuit. Perspectives on Psychological Science, 15(1), 150 to 172. [verify]
- Harsey, S., & Freyd, J. J. (2020). Deny, attack, and reverse victim and offender (DARVO): What is the influence on perceived perpetrator and victim credibility? Journal of Aggression, Maltreatment & Trauma, 29(8), 897 to 916. [verify]
...
- Krizan, Z., & Herlache, A. D. (2018). The narcissism spectrum model: A synthetic view of narcissistic personality. Personality and Social Psychology Review, 22(1), 3 to 31. [verify]
...
- Morf, C. C., & Rhodewalt, F. (2001). Unraveling the paradoxes of narcissism: A dynamic self-regulatory processing model. Psychological Inquiry, 12(4), 177 to 196. [verify]
- Pincus, A. L., Ansell, E. B., Pimentel, C. A., Cain, N. M., Wright, A. G. C., & Levy, K. N. (2009). Initial construction and validation of the Pathological Narcissism Inventory. Psychological Assessment, 21(3), 365 to 379. [verify]
...
- Raskin, R., & Terry, H. (1988). A principal-components analysis of the Narcissistic Personality Inventory and further evidence of its construct validity. Journal of Personality and Social Psychology, 54(5), 890 to 902. [verify]
...
- Steele, C. M. (1988). The psychology of self-affirmation: Sustaining the integrity of the self. Advances in Experimental Social Psychology, 21, 261 to 302. [verify]
...
- Sweet, P. L. (2019). The sociology of gaslighting. American Sociological Review, 84(5), 851 to 875. [verify]
