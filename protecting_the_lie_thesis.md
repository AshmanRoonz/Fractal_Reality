...
**The orbit sentence:** The belief is not allowed to lose. Everything else in the model is that sentence unpacked: supply reports that it has not lost today; contradiction is the event of it losing; the protection operations are the machinery that prevents the loss from registering; and treatment is whatever makes losing survivable.
...
**Proposition 3.1 (function inversion).** Supply-seeking is instrumentally subordinate to Lie protection: the value of a supply event to the organization equals its confirmation content with respect to L, not its hedonic content.
