# Circumpunct Ethics & Virtues: Core Reference

**Author:** Ashman Roonz (email@ashmanroonz.ca)
**Source:** The Circumpunct Framework — https://fractalreality.ca
...
The boundary is what cares. It says: this belongs inside, that belongs outside. Every wall exists because something matters enough to be sheltered. Consent is the structural requirement for healthy exchange: the foreseeable effects of what crosses my boundary are within what I understand and accept.
...
### 1. PLASTICITY keeps GOOD alive
The boundary that can flex, reshape, respond. Not rigid, not dissolved. A living membrane. Plasticity lets care be genuine: you adjust based on what is actually there, not what you decided in advance.
...
## Diagnostics: Checking State

### Self-Check (each virtue)

**Plasticity:**
- Can my boundaries flex when conditions change?
- Do I feel at the meeting place, or have I gone numb?
- (Warning) Are my boundaries rigid walls or completely absent?
- (Warning) Do I impose care without sensing what is needed?
...
- (Warning) When someone says "not quite," do I argue?
- (Warning) Do I already know what they are going to say?

**Validation:**
- Am I looking for myself, or accepting someone's version?
- When I agree, is it because I see it too?
- (Warning) Am I complying to avoid conflict?
- (Warning) Have I stopped checking whether we genuinely see the same thing?
...
- **Local aperture (the gate):** Your own consciousness. Personal integrity; keeping your own passage clear.
- **Global aperture (the whole):** Viewed from outside, the whole thing is just one aperture. Social responsibility; participating as one opening in the larger field.

Ethical action happens at both scales simultaneously. To neglect either is to break the chain. Personal integrity without social responsibility is selfishness. Social responsibility without personal integrity is self-erasure.
...
The Circumpunct Framework, including all ethics and virtues content, was created by **Ashman Roonz**. For the complete framework, visit https://fractalreality.ca or see the full theory at https://github.com/AshmanRoonz/Fractal_Reality
