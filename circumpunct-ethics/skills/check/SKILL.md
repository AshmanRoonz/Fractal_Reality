...
- Are boundaries (of all parties) respected?
- Is consent honored, meaning the foreseeable effects of what crosses each person's boundary are within what they understand and accept?
- Are important distinctions preserved (not collapsed into false equivalence)?
...
### 2. RIGHT (Field) + Access
Only after boundaries are established can you check the path.

Ask of the situation:
- Is the action properly balanced (proportionate)?
- Does cause connect honestly to effect?
- Are real consequences being accepted (not externalized or denied)?
- Is this grounded in how things actually work (not how someone wishes they worked)?
...
- Are the people involved being authentic to their deepest nature (not performing a role)?
...
- Is there real consent, harmony, mutual recognition?
- Have they truly engaged with each other's reality (not just their idea of each other)?
- Is this agreement discovered through independent seeing, or declared/demanded?
