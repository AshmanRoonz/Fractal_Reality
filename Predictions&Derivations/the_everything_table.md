...
| Transition | Δ​E (eV) | λ_theory (nm) | λ_observed (nm) | Name | Error |
|------------|---------|---------------|-----------------|------|-------|
...
**Free Parameters:** **ZERO** - all derived from:
...
| Approach | Prediction | Orders Off | Free Parameters | Status |
|----------|-----------|------------|----------------|--------|
...
**The Everything Table is complete.**  
